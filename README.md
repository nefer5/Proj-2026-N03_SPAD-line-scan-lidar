...
**V0.1.7：H/V空间binning。** 以H_binning、V_binning替代可编辑总SPAD数，默认4×4，乘积统一供核心使用；旧总数配置迁移为一行。滤光片范围改为855–955nm，10nm矩形通带的加权带宽仍为8nm。PDE/太阳备用中心保持独立，界面显示当前生效模式和激光处PDE。说明见 [空间binning与参数联动](docs/binning.md)。
